...
namespace Mood.Draw
{
    public class SanphamDraw
    {
        ...
        public IEnumerable<SanPhamModel> sachcu(string searhString, int page, int pagesize)
        {
            ...
            if (!string.IsNullOrEmpty(searhString))
            {
                result = (from a in db.Categories
                          ...
                          where b.Name.Contains(searhString) && b.Quanlity == "cũ nát" || b.ThuongHieu.Contains(searhString)&& b.Quanlity == "cũ nát" || a.TenTheloai.Contains(searhString) && b.Quanlity =="cũ nát" || c.TenNCC.Contains(searhString) && b.Quanlity == "cũ nát" || f.UserName.Contains(searhString) && b.Quanlity == "cũ nát"
                          select new SanPhamModel()
                          {
                              IDContent = b.IDContent,
                              Name = b.Name,
                              Metatile = b.MetaTitle,
                              ThuongHieu = b.ThuongHieu,
        ...
        public IEnumerable<Sanpham> hetHang(string searhString, int page, int pagesize)
        {
            ...
            if (!string.IsNullOrEmpty(searhString))
            {
                model = model.Where(x => x.Name.Contains(searhString) || x.ThuongHieu.Contains(searhString));
        ...
        public IEnumerable<SanPhamModel> listTheloai(string searhString,int page,int pagesize)
        {
            ...
            if (!string.IsNullOrEmpty(searhString))
            {
                 result = (from a in db.Categories
                           join b in db.Sanphams on a.IDCategory equals b.CategoryID
                           where b.Name.Contains(searhString) || b.ThuongHieu.Contains(searhString) || a.TenTheloai.Contains(searhString)
                              select new SanPhamModel()
                              {
                                  IDContent = b.IDContent,
                                  Name = b.Name,
        ...
        public IEnumerable<SanPhamModel> getByIDcate(long idCate,string searhString,int page,int pageSize)
        {
            ...
            if (!string.IsNullOrEmpty(searhString))
            {
                result = (from a in db.Categories
                          join b in db.Sanphams on a.IDCategory equals b.CategoryID
                          where b.CategoryID == idCate && b.Name.Contains(searhString) || b.CategoryID == idCate && b.ThuongHieu.Contains(searhString) || a.TenTheloai.Contains(searhString)
                          select new SanPhamModel()
                          {
                              IDContent = b.IDContent,
                              Name = b.Name,
        ...
        public bool Update(Sanpham model)
        {
            try
            {
                ...
                sp.Name = model.Name;
                sp.NhaSanXuat = model.NhaSanXuat;
                sp.ThuongHieu = model.ThuongHieu;
